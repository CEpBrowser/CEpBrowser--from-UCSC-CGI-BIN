...
// Hack: making transparency gradients
#ifdef COLOR32
void hMakeTransparency(struct hvGfx *hvg, Color *shades, int maxShade);
/* Make up transparency scale with 0 = transparent, and maxShade = opaque. 
 * Shades needs to have maxShade+1 colors. */
#endif
// End hack
