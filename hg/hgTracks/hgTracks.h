...
#ifndef PRIVATE_CGI
#define CEPBROWSER_TARGET "trackSettingFrame"
#define CEPBROWSER_HGTRACKS "../cgi-bin/hgTracks"
#define CEPBROWSER_HGTRACKUI "../cgi-bin/hgTrackUi"
#endif
...
// Hack: shadeOfTransparency
#ifdef COLOR32
extern Color shadesOfTransparency[50+1];  /* 10 shades of gray from white to black
                                   * Red is put at end to alert overflow. */
#endif
// End hack
...
extern boolean CBIsInBrowser;			// decide whether the track is in CEpBrowser
...
/* HACK: Return transparent shade corresponding to a number from minVal - maxVal */
